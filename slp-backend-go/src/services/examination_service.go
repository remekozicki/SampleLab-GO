...
func GetAllExaminationsForSample(sampleID uint) ([]dto.ExaminationDto, error) {
...
func GetExaminationByID(id uint) (*dto.ExaminationDto, error) {
...
func DeleteExamination(id uint) error {
